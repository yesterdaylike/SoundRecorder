...
public class Recorder implements OnCompletionListener, OnErrorListener {
	...
	public void startRecording(int outputfileformat, String extension, Context context) {
		...
		if (outputfileformat == MediaRecorder.OutputFormat.AMR_NB)
			mRecorder.setAudioEncoder(MediaRecorder.AudioEncoder.AMR_NB);
		else if (outputfileformat == MediaRecorder.OutputFormat.AMR_WB)
			mRecorder.setAudioEncoder(MediaRecorder.AudioEncoder.AMR_WB);
		else {
			mRecorder.setAudioEncoder(MediaRecorder.AudioEncoder.AAC);
			mRecorder.setAudioEncodingBitRate(64*1024);
	...
	public void startPlayback(String absolutePath, Object lengthObject) {
		mSampleFile = new File(absolutePath);
		long lengthLong = (Long)lengthObject;
		mSampleLength = (int)lengthLong;
		startPlayback();
	}
